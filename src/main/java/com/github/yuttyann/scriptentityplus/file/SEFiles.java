...
import static com.github.yuttyann.scriptblockplus.file.SBFiles.loadLang;

public final class SEFiles implements Listener {

    public static final String PATH_CONFIG = "scriptentityplus_config_{code}.yml";
    public static final String PATH_MESSAGE = "scriptentityplus_message_{code}.yml";
    ...
    public static void register() {
        ...
        plugin.getServer().getPluginManager().registerEvents(new SEFiles(), plugin);
    }

    public static void reload() {
        Plugin plugin = ScriptBlock.getInstance();
        ConfigKeys.load(loadLang(plugin, PATH_CONFIG, "config/scriptentityplus"));
        ConfigKeys.load(loadLang(plugin, PATH_MESSAGE, "message/scriptentityplus"));
